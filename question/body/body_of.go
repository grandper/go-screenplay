...
// ErrFieldNotFound is returned when the struct answered by the wrapped question has no Body field.
var ErrFieldNotFound = errors.New("the answer of the question has no Body field")

// Of creates a question whose answer is the Body field of the struct answered by the wrapped question.
...
// OfQuestion is a question whose answer is the Body field of the answer of the wrapped question.
type OfQuestion struct {
	question screenplay.Question
}

// AnsweredBy returns the Body field of the struct answered by the wrapped question.
...
func (q *OfQuestion) String() string {
	return "body of " + q.question.String()
}
