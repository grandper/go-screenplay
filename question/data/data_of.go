...
// ErrFieldNotFound is returned when the struct answered by the wrapped question has no Data field.
var ErrFieldNotFound = errors.New("the answer of the question has no Data field")

// Of creates a question whose answer is the Data field of the struct answered by the wrapped question.
...
// OfQuestion is a question whose answer is the Data field of the answer of the wrapped question.
type OfQuestion struct {
	question screenplay.Question
}

// AnsweredBy returns the Data field of the struct answered by the wrapped question.
...
func (q *OfQuestion) String() string {
	return "data of " + q.question.String()
}
