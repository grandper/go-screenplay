...
import (
	...
	"github.com/grandper/go-screenplay/resolution/less"
	"github.com/grandper/go-screenplay/resolution/testdata"
)

func TestLessThanResolution(t *testing.T) {
	matcher := less.Than(2.5)
	...
	t.Run("implements the stringer interface", func(t *testing.T) {
		assert.Equal(t, "less than 2.5", matcher.String())
	})
}
