...
import (
	...
	"github.com/grandper/go-screenplay/resolution/length"
	"github.com/grandper/go-screenplay/resolution/testdata"
)

func TestLengthOfResolution(t *testing.T) {
	matcher0 := length.Of(0)
	matcher1 := length.Of(1)
	matcher2 := length.Of(2)
