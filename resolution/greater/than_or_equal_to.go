...
// ThanOrEqualTo creates a matcher to tell if a number is greater than or equal to a given number.
...
// ThanOrEqualToResolution is a matcher to tell if a number is greater than or equal to a given number.
