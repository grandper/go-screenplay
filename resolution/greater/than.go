...
// Than creates a matcher to tell if a number is greater than a given number.
...
// ThanResolution is a matcher to tell if a number is greater than a given number.
