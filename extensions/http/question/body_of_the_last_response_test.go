...
func TestBodyOfTheLastResponseQuestion(t *testing.T) {
	t.Run("returns the body of the last response", func(t *testing.T) {
	...
	t.Run(
		"fails to get the body of the last response if the actor does not have the ability MakeHttpRequest",
		func(t *testing.T) {
	...
	t.Run("implements the stringer interface", func(t *testing.T) {
		body := question.BodyOfTheLastResponse()
		assert.Equal(t, "body of the last response", body.String())
	})
}
